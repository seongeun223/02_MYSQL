...
values (1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hon123@gamil.com'),
...
insert into user_unique
    (user_no, user_id, user_pwd, user_name, gender, phone, email)
values (1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hon123@gamil.com'),
       (2, 'user02', 'pass02', '유관순', '여', '010-7777-7777', 'yu77@gamil.com');
...
create table if not exists user_forignkey1
(
    user_no    int primary key,
    user_id   varchar(255) not null,
    user_pwd   varchar(255) not null,
...
select *
from user_forignkey1;

insert into user_forignkey1
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
values (1, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hon123@gamil.com', 10),
...
-- (`user_db`.`user_forignkey1`, CONSTRAINT `user_forignkey1_ibfk_1` FOREIGN KEY (`grade_code`) REFERENCES `user_grade` (`grade_code`))
insert into user_forignkey1
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
values (3, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hon123@gamil.com', 50);
...
-- [23000][1452] Cannot add or update a child row: a foreign key constraint fails
-- (`user_db`.`user_forignkey1`, CONSTRAINT `user_forignkey1_ibfk_1` FOREIGN KEY (`grade_code`) REFERENCES `user_grade` (`grade_code`))
update user_forignkey1
set grade_code = 5
where user_no = 2;

-- check
-- check 제약 조건을 위반 시 허용하지 않음
