...
drop table if exists tbl_country, user_check, user_forignkey1, user_grade, user_notnull, user_primarykey, user_unique;
...
#set global sql_mode = ''; -- 쓸일이 없음

-- DROP
-- 테이블을삭제하기 위한 구문
-- if exists 를 적용하면 존재하지 않는 태이블이라도 에러가 발생하지 않는다.
...
-- 테이블을 여러 개 삭제
drop table if exists tb1, tb2, tb3, tb4,tb5;
